...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator(${($_ = isset($this->services['file_locator']) ? $this->services['file_locator'] : $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, '/app/app/Resources', array(0 => '/app/app'))) && false ?: '_'}, $this->targetDirs[0]);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/app/vendor/doctrine/doctrine-bundle/Resources/views', '!Doctrine');
        $instance->addPath('/app/src/AppBundle/Resources/views', 'App');
        $instance->addPath('/app/src/AppBundle/Resources/views', '!App');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => '/app/app/../var/sessions/dev',
